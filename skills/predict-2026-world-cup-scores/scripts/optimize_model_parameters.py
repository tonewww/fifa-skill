...
GRIDS = {
    "daily": {
        "base_goals": [1.28, 1.36],
        "attack_weight": [0.85],
        "overall_weight": [0.55],
        "formation_weight": [0.25],
        "recent_goal_openness_weight": [0.38],
        "formation_openness_weight": [0.45],
        "wdl_prior_weight": [0.70],
        "formation_wdl_prior_max_weight": [0.25],
        "wdl_score_calibration_weight": [0.80],
        "favorite_score_tilt": [0.10, 0.18],
        "draw_score_tilt": [-0.04, 0.06],
        "high_total_score_boost": [0.24, 0.34],
        "very_high_total_score_boost": [0.18, 0.28],
        "nil_nil_dampener": [0.08, 0.16],
        "one_goal_win_dampener": [0.04, 0.08],
        "open_draw_score_boost": [0.10],
        "btg_score_boost": [0.10, 0.16],
        "stage_data_weight": [0.45],
        "stage_open_match_resistance": [0.30],
        "dixon_coles_rho": [0.0],
        "zero_inflation": [0.08, 0.14],
    },
    "smoke": {
        "base_goals": [1.18, 1.28, 1.36],
        "attack_weight": [0.85],
        "overall_weight": [0.55],
        "formation_weight": [0.25],
        "recent_goal_openness_weight": [0.32, 0.42],
        "formation_openness_weight": [0.45],
        "wdl_prior_weight": [0.70],
        "formation_wdl_prior_max_weight": [0.25],
        "wdl_score_calibration_weight": [0.80],
        "favorite_score_tilt": [0.08, 0.16],
        "draw_score_tilt": [-0.04, 0.06],
        "high_total_score_boost": [0.14, 0.26, 0.34],
        "very_high_total_score_boost": [0.08, 0.18, 0.28],
        "nil_nil_dampener": [0.12, 0.20],
        "one_goal_win_dampener": [0.04, 0.08],
        "open_draw_score_boost": [0.08, 0.14],
        "btg_score_boost": [0.06, 0.14],
        "stage_data_weight": [0.45],
        "stage_open_match_resistance": [0.30],
        "dixon_coles_rho": [0.0],
        "zero_inflation": [0.12],
    ...
    "full": {
        ...
        "open_draw_score_boost": [0.04, 0.10, 0.18],
        "btg_score_boost": [0.04, 0.10, 0.18],
        "stage_data_weight": [0.30, 0.55, 0.80],
        "stage_sample_half_life": [18.0, 36.0, 72.0],
        "stage_open_match_resistance": [0.20, 0.45, 0.70],
        "dixon_coles_rho": [0.0],
        "zero_inflation": [0.05, 0.10, 0.18, 0.25],
    },
}
