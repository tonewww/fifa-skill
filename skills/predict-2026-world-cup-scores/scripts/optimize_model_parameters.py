...
GRIDS = {
    "smoke": {
        ...
        "recent_goal_openness_weight": [0.20, 0.32],
        "formation_openness_weight": [0.25, 0.45],
        "wdl_prior_weight": [0.50, 0.70],
        "formation_wdl_prior_max_weight": [0.25],
        "wdl_score_calibration_weight": [0.55, 0.80],
        "favorite_score_tilt": [0.08],
        "stage_data_weight": [0.45, 0.80],
        "stage_open_match_resistance": [0.30, 0.55],
    },
    "coarse": {
